...
export default async function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 sm:px-6 lg:px-8 py-6">
      ...
      {/* Key Metrics + Weekly Chart */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-8">
        {/* Key Metrics */}
        <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4 sm:mb-6">Key Metrics</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
            ...
            {/* Low Stock */}
            <div className="text-center">
              <div className="text-2xl sm:text-3xl font-bold text-gray-900">{lowStock}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-8">
        ...
        {/* Efficiency */}
        <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6 flex flex-col items-center">
          ...
          <div className="mt-4 sm:mt-6 space-y-2 w-full">
